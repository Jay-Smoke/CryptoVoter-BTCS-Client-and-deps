 ...
 *
 ***************************************************************************/
#ifndef VOTETRANSACTIONS_H
#define VOTETRANSACTIONS_H
...
namespace Ui {
class VoteTransactions;
}

class VoteTransactionsForm : public QWidget
{
    Q_OBJECT

public:
    explicit VoteTransactionsForm(QWidget *parent = 0);
    ~VoteTransactionsForm();

public slots:
    void refresh();
private:
    Ui::VoteTransactions *ui;
    QStandardItemModel *modelRegisters;
    QSortFilterProxyModel *registersProxyModel;
    void addRegister(VoteRegister voteRegister);



};

#endif // VOTETRANSACTIONS_H
