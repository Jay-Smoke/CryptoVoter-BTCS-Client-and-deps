...
public:
    ...
    Question();
    Question(QString quid, QString question, QString endDate, state_e state=pending);
    QString getId() const;
    void setId(QString id);
    QString getQuestion() const;
    void setQuestion(QString question);
    QString getEndDate() const;
    QString getHumanEndDate();
    ...
    void setCoin(const QString &value);
    ...
    void setRemainingTime(const QString &value);
