 ...
 *
 ***************************************************************************/
#ifndef QUESTIONAPIDAOREQUESTMANAGER_H
#define QUESTIONAPIDAOREQUESTMANAGER_H
...
class QuestionApiDAORequestManager : public QObject
{
    Q_OBJECT
public:
    typedef enum{
    ...
    explicit QuestionApiDAORequestManager(QObject *parent = 0);
    static QuestionApiDAORequestManager *getInstance();

private:
    static QuestionApiDAORequestManager *instance;
...
public slots:
    ...
    void executeRequest(QNetworkRequest request);
    void setup();


};

#endif // QUESTIONAPIDAOREQUESTMANAGER_H
