...
#define APPNAME "CryptoVoter-BTCS"
...
private:
    ...
    static std::string revisionVersion;
    static std::string majorVersion;
    static std::string minorVersion;
    static std::string svnRevision;
    static std::string svnURL;
    static std::string jenkinsBuild;
    static std::string gccVersion;

public:
    /* GETTERS */
    static std::string getAppName();
    static std::string getRevisionVersion();
    static std::string getMajorVersion();
    static std::string getMinorVersion();
    static std::string getSvnRevision();
    static std::string getSvnURL();
    static std::string getJenkinsBuild();
    ...
    static std::string getAppNameShortVersion();
