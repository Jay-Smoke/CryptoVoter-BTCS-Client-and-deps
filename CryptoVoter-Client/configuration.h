...
{
public:
    static Configuration *getInstancia();
    QString getWalletPath();
    void setWalletPath(QString path);
    bool getEULAAcceptance();
    void setEULAAcceptance(bool accept);
    void setNetFee(double netfee);
    double getNetFee();

private:
    static Configuration *instancia;
    QSettings *settings;
    Configuration();
